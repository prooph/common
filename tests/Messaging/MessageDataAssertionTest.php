...
class MessageDataAssertionTest extends TestCase
{
    ...
    public function provideMessageDataWithMissingKey()
    {
        ...
        $createdAt = (new \DateTimeImmutable('now', new \DateTimeZone('UTC')))->format('Y-m-d\TH:i:s.uP');
